...
| Point On Child Element Within Parent Element                                          | Points the specified Child Web Element within the Parent Web Element.                                                                                             |
...
| Click And Hold Child Element Within Parent Element                                    | Clicks and holds the specified Child Web Element within the Parent Web Element.                                                                                   |
...
| Click On Child Element Within Parent Element                                          | Clicks the specified Child Web Element within the Parent Web Element.                                                                                             |
| ClickJS On Child Element Within Parent Element                                        | Clicks the specified Child Web Element within the Parent Web Element (utilizing Javascript).                                                                      |
...
| Double Click On Child Element Within Parent Element                                   | Double-clicks the specified Child Web Element within the Parent Web Element.                                                                                      |
...
| Type On Child Element Within Parent Element                                           | Simulates typing into a text box/area Child Web Element within the Parent Web Element.                                                                            |
...
| Press On Child Element Within Parent Element                                          | Simulates pressing of characters into a text box/area Child Web Element within the Parent Web Element.                                                            |
...
| Clear Child Element Within Parent Element                                             | Clears value of the specified Child Web Element within the Parent Web Element.                                                                                    |
...
| Get Text From Child Element Within Parent Element                                     | Gets the visible innerText of the specified Child Web Element within the Parent Web Element.                                                                      |
...
| Get Value From Child Element Within Parent Element                                    | Gets the value of the INPUT and TEXTAREA Child Web Element within the Parent Web Element.                                                                         |
...
| Get Attribute Value From Child Element Within Parent Element                          | Gets the value of the specified attribute of the Child Web Element within the Parent Web Element.                                                                 |
