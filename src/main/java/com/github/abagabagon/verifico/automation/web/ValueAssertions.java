...
public class ValueAssertions extends Commands {
	 ...
	 * 
	 * @param	partialUrl Expected Partial Page URL to compare into
	 * @return	<code>true</code> if Page URL is not partially equal to specified URL.
	 * 			<code>false</code> if Page URL is partially equal to specified URL.
	 */
	...
	/**
	 * Verifies the attribute value of the Web Element of the specified Locator
	 * if equal to the expected value.
	 * 
	 * @param locator	Object used to locate Web Element to assert the attribute value from.
	 ...
	 * Locator if equal to the expected value.
	 * 
	 * @param parent	Locator of the Parent Web Element
	 * @param child		Locator of the Child Web Element to assert the attribute value from.
	 * @param attribute	Name of attribute to assert the value from.
	...
	/**
	 * Verifies the attribute value of the Web Element of the specified Child
	 * Locator within the context of the Parent Web Element Locator if equal
	 ...
	 * Verifies the attribute value of the Web Element of the specified Child
	 * Locator within the context of the Web Element of the specified Parent
	 * Locator if not equal to the expected value.
	 * 
	 * @param parent	Locator of the Parent Web Element
	 * @param child		Locator of the Child Web Element to assert the attribute value from.
	 * @param attribute	Name of attribute to assert the value from.
	 ...
	 * 			<code>false</code> if value is not partially equal to expected attribute value.
	 */
	 ...
	 * Verifies the attribute value of the Web Element of the specified Child
	 * Locator within the context of the Web Element of the specified Parent
	 * Locator if partially equal to the expected value.
	 * 
	 * @param parent	Locator of the Parent Web Element
	 * @param child		Locator of the Child Web Element to assert the attribute value from.
	 * @param attribute	Name of attribute to assert the value from.
	 ...
	 * @param attribute	Name of attribute to assert the value from.
	 * @param value		Value of the Web Element Text Dropdown to check.
	 * @return	<code>true</code> if value is not partially equal to expected attribute value.
	 ...
	 * Verifies the attribute value of the Web Element of the specified Child
	 * Locator within the context of the Web Element of the specified Parent
	 * Locator if not partially equal to the expected value.
	 * 
	 * @param parent	Locator of the Parent Web Element
	 * @param child		Locator of the Child Web Element to assert the attribute value from.
	 * @param attribute	Name of attribute to assert the value from.
	...
	/**
	 * Verifies the text value of the Web Element of the specified Locator
	 * if equal to the expected value.
	 * 
	...
	/**
	 * Verifies the text value of the Web Element of the specified Child
	 * Locator within the context of the Web Element of the specified Parent
	 * Locator if equal to the expected value.
	 * 
	 * @param parent	Locator of the Parent Web Element
	 ...
	 * 			<code>false</code> if value is not partially equal to expected text value.
	 */
	 ...
	 * @param locator	Object used to locate Web Element to assert the text value from.
	 * @param value		Value of the Web Element Text Dropdown to check.
	 * @return	<code>true</code> if value is not partially equal to expected text value.
	 * 			<code>false</code> if value is partially equal to expected text value.
	 */
	...
	/**
	 * Verifies the dropdown value of the Web Element of the specified Locator
	 * if equal to the expected value.
	 * 
	 * @param locator	Object used to locate Web Element to assert the dropdown value from.
	 * @param value		Expected value of the Web Element Text Dropdown.
	...
	/**
	 * Verifies the dropdown value of the Web Element of the specified Child
	 * Locator within the context of the Web Element of the specified Parent
	 * Locator if equal to the expected value.
	 * 
	 * @param parent	Locator of the Parent Web Element
	 * @param child		Locator of the Child Web Element to assert the dropdown value from.
	 * @param value		Expected value of the Child Web Element Text Dropdown.
	 * @return	<code>true</code> if value is equal to expected dropdown value.
	 * 			<code>false</code> if value is not equal to expected dropdown value.
	 */
	 ...
	 * @param locator	Object used to locate Web Element to assert the dropdown value from.
	 * @param value		Expected partial value of the Web Element Text Dropdown.
	 * @return	<code>true</code> if value is partially equal to expected dropdown value.
	 * 			<code>false</code> if value is not partially equal to expected dropdown value.
	 */
	 ...
	 * @param locator	Object used to locate Web Element to assert the dropdown value from.
	 * @param value		Value of the Web Element Text Dropdown to check.
	 * @return	<code>true</code> if value is not partially equal to expected dropdown value.
	 * 			<code>false</code> if value is partially equal to expected dropdown value.
	 */
