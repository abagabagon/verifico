...
public class StateAssertions extends Commands {
	...
	/**
	 * Verifies if Web Element of specified Locator within the context of the Web
	 * Element of the specified Parent Locator is displayed on Web Page.
	 *
	...
	/**
	 * Verifies if Web Element of specified Locator within the context of the Parent
	 * Web Element is displayed on Web Page.
	 *
	...
	/**
	 * Verifies if Web Element of specified Locator within the context of the Web
	 * Element of the specified Parent Locator is not displayed on Web Page.
	 *
	 * @param parent Locator of Parent Web Element.
	 * @param child  Locator of Child Web Element to check.
	 * @return <code>true</code> if Web Element is not displayed on Web Page.
	...
	/**
	 * Verifies if Web Element of specified Locator within the context of the Parent
	 * Web Element is not displayed on Web Page.
	 *
	 * @param parent Parent Web Element.
	 * @param child  Locator of Child Web Element to check.
	 * @return <code>true</code> if Web Element is not displayed on Web Page.
	...
	/**
	 * Verifies if Web Element of specified Locator within the context of the Web
	 * Element of the specified Parent Locator is enabled on Web Page.
	 *
	 * @param parent Locator of Parent Web Element.
	 * @param child  Locator of Child Web Element to check.
	 * @return <code>true</code> if Web Element is enabled on Web Page.
	...
	/**
	 * Verifies if Web Element of specified Locator within the context of the Parent
	 * Web Element is enabled on Web Page.
	 *
	 * @param parent Parent Web Element.
	 * @param child  Locator of Child Web Element to check.
	 * @return <code>true</code> if Web Element is enabled on Web Page.
	...
	/**
	 * Verifies if Web Element of specified Locator within the context of the Web
	 * Element of the specified Parent Locator is disabled on Web Page.
	 *
	 * @param parent Locator of Parent Web Element.
	 * @param child  Locator of Child Web Element to check.
	 * @return <code>true</code> if Web Element is disabled on Web Page.
	...
	/**
	 * Verifies if Web Element of specified Locator within the context of the Parent
	 * Web Element is disabled on Web Page.
	 *
	 * @param parent Parent Web Element.
	 * @param child  Locator of Child Web Element to check.
	 * @return <code>true</code> if Web Element is disabled on Web Page.
	...
	/**
	 * Verifies if Web Element of specified Locator within the context of the Web
	 * Element of the specified Parent Locator is selected on Web Page.
	 *
	 * @param parent Locator of Parent Web Element.
	 * @param child  Locator of Child Web Element to check.
	 * @return <code>true</code> if Web Element is selected on Web Page.
	...
	/**
	 * Verifies if Web Element of specified Locator within the context of the Parent
	 * Web Element is selected on Web Page.
	 *
	 * @param parent Parent Web Element.
	 * @param child  Locator of Child Web Element to check.
	 * @return <code>true</code> if Web Element is selected on Web Page.
	...
	/**
	 * Verifies if Web Element of specified Locator within the context of the Web
	 * Element of the specified Parent Locator is deselected on Web Page.
	 *
	 * @param parent Locator of Parent Web Element.
	 * @param child  Locator of Child Web Element to check.
	 * @return <code>true</code> if Web Element is deselected on Web Page.
	...
	/**
	 * Verifies if Web Element of specified Locator within the context of the Parent
	 * Web Element is deselected on Web Page.
	 *
	 * @param parent Parent Web Element.
	 * @param child  Locator of Child Web Element to check.
	 * @return <code>true</code> if Web Element is deselected on Web Page.
