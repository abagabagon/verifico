...
public class WebElementFactory {
	...
	/**
	 * Creates Web Element from the specified List Web Element by iterating thru
	 * all Web Elements and checking if the element's text matches the text reference
	 ...
	 * 								from based on the text reference value.
	 * @param textReferenceValue	Text reference to check for each Web Element
	...
	/**
	 * Creates Web Element from the specified List Web Element by iterating thru
	 * all Web Elements and checking if the element's attribute value matches the attribute reference
	 * value. Web Element that first matches the attribute value will be returned.
	 * 
	 * Note: Command is useful for manipulating a specific Web Element from a List Web Element.
	 * 
	 * @param	elementList				List Web Element to create a Web Element
	 ...
	 * specified List Web Element by iterating thru all Web Elements and checking
	 * if the text of the nested Child Reference Web Element matches the text reference
	 ...
	 * 
	 * <ul>
	 *     <li>The Parent List Web Element is the List Web Element for the rows of the table.</li>
	 ...
	 *     <li>The Text Reference Value will depend on the specific row the user intends to manipulate (e. g. "Jane Doe").</li>
	 * </ul>
	 *  
	 * 
	 * Note: As shown above, command is useful for manipulating a specific Web Elements in a table.
	 * 
	 * @param	parentList				List Web Element to create a Child Web Element
	 * 									from based on the text reference value of 
	 ...
	 * @param	textReferenceValue		Text reference to check at the Child Web
	 * 									Element Reference for each Web Element
	 * 									of the Parent List Web Element.
	 * @return	Created Web Element from the List Web Element based on the Child Web Element Reference text
	 * 			value. 
	 */
	 ...
	 * Creates a nested Child Web Element from one of the Web Elements of the
	 * specified List Web Element by iterating thru all Web Elements and checking
	 * if the attribute value of the nested Child Reference Web Element matches
	 * the attribute reference value. Child Web Element to create under a Web
	 ...
	 *     <li>The Child Web Element Reference is the employee name column value.</li>
	 *     <li>The Child Web Element to Create is the link column.</li>
	 *     <li>The attribute will be the reference attribute of the Child Web Element Reference.</li>
	 *     <li>The Attribute Reference Value will depend on the specific row the user intends to manipulate.</li>
	 * </ul>
	 *  
	 * 
	 * Note: As shown above, command is useful for manipulating a specific Web Elements in a table.
	 ...
	 * 										Element Reference for each Web Element
	 * 										of the Parent List Web Element.
	 * @return	Created Web Element from the List Web Element based on the Child Web Element Reference attribute
	 * 			value. 
	 */
	 ...
	 * iterating thru all Web Elements and checking if the text of the nested
	 * Child Reference Web Element matches the text reference value. Child Web
	...
	/**
	 * Under the context of an ancestor Web Element, creates a nested Child Web
	 * Element from one of the Web Elements of the specified List Web Element
	 * by iterating thru all Web Elements and checking if the attribute value
	 * of the nested Child Reference Web Element matches the attribute reference
